...
public class LogWriter {
    ...
    private final String finalHeader = "Final state of router {0} table:\n[Source IP]\t\t[Destination IP]\t[Next Hop]\t\t[Metric]\n";
    ...
    public void writeFinalState(String ip, RoutingTable table) throws IOException {
        Files.write(path, MessageFormat.format(finalHeader, ip).getBytes(), StandardOpenOption.APPEND);
        writeTable(ip, table);
    }

    private void writeTable(String ip, RoutingTable table) throws IOException {
